...
fs.readFile('./mainSound/json/sounds.json', 'utf8', (err, data) => {
    if (err) {
        ...
        document.getElementById("main").innerHTML += `<button class="btn btn-primary soundButton"  id="AddSoundButton" onclick="addButton()" style="height: 100px; width: 100px;">+</button>`
